  ...
  <main>
    <section class="section">
      ...
      <div class="category-tabs main-tabs">
        <button class="tab-btn active" data-tab="manage">Manage Events</button>
        <button class="tab-btn" data-tab="requests">Event Requests</button>
      </div>
 ...
 ?>
          ...
          <div class="body">
            ...
            <div class="actions">
                    ...
                    <a href="edit_event.php?id=<?php echo $row['id'];?>" class="btn primary">View Details</a> 
...
$stmt = $pdo->query("SELECT * FROM new_events ORDER BY id DESC");
while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
 ...
 ?>
           ...
           <article class="h-card" data-category="<?php echo $row['event_category'];?>">
            <div class="media">
             <img src="/show_image.php?type=poster&tab=new&id=<?php echo $row['id'];?>"  >
             </div>
          <div class="body">
             <div class="info">
             <div class="pill"><?php echo date("F j, Y", strtotime($row['event_date']));?></div>
            ...
            <div class="actions">
                    ...
                    <a href="new_events.php?id=<?php echo $row['id'];?>" class="btn primary">View Details</a> 
