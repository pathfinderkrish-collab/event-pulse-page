  ...
  <main>
    <section class="section">
      ...
      <div class="category-tabs main-tabs">
        ...
        <button class="tab-btn" data-tab="requests">Registered Events</button>
      </div>
...
$stmt2 = $pdo->prepare("SELECT COUNT(*) FROM registrations WHERE event_id = ? AND student_id = ?");
$stmt2->execute([$row['id'], $u_id]);
$already_registered = $stmt2->fetchColumn();
