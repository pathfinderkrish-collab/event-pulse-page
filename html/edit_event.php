 ...
 <section class="event-section">
    ...
    <aside class="sidebar">
      <div class="sidebar-card" id="actionButtons">
        <button class="btn danger" style="width:100%" id="registerBtn" onclick="window.location.href='manage_event.php?cmd=del&type=eve&id=<?php echo $row['id'];?>'" >Delete Event</button>
      </div>
