 ...
 <section class="event-section">
    ...
    <aside class="sidebar">
     ...
     <div class="sidebar-card" id="actionButtons" style="display: flex; gap: 10px;">
        <button class="btn success" style="flex: 1;" onclick="window.location.href='manage_event.php?cmd=accept&id=<?php echo $row['id'];?>'">Accept</button>
        <button class="btn" style="flex: 1; background-color: #dc3545; color: #fff;" onclick="window.location.href='manage_event.php?cmd=del&id=<?php echo $row['id'];?>'">Reject</button>
      </div>
